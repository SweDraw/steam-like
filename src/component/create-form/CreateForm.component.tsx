        ...
        <article className="create-form__field create-form__field--agree">
          ...
          <div id="create-form__agree-politics">
            ...
            <ol style={{marginLeft: 13}}>
              <li><a href="#1">Регистрация в качестве подписчика. Условия использования. Ваш аккаунт</a></li>
              <li><a href="#2">Лицензии</a></li>
              <li><a href="#3">Биллинг, платежи и другие подписки</a></li>
              <li><a href="#4">Нормы поведения в Интернете, мошенничество в игре и иные незаконные действия</a></li>
              <li><a href="#5">Контент сторонних производителей</a></li>
              <li><a href="#6">Пользовательский контент</a></li>
              <li><a href="#7">Отказ от ответственности; ограничение ответственности; отсутствие гарантийных
                обязательств; ограниченная гарантия и соглашение</a></li>
              <li><a href="#8">Внесение изменений в соглашение</a></li>
              <li><a href="#9">Срок действия соглашения и условия расторжения</a></li>
              <li><a href="#10">Применимое право/посредничество/юрисдикция/расходы на юриста</a></li>
              <li><a href="#11">Разрешение споров/обязательный арбитраж/отказ от коллективного иска</a></li>
              <li><a href="#12">Разное</a></li>
            </ol>
            ...
            <i id="10"/>
            <p>10. ПРИМЕНИМОЕ ПРАВО/ПОСРЕДНИЧЕСТВО/ЮРИСДИКЦИЯ/РАСХОДЫ НА ЮРИСТА<a href="#0"><small> ⏶</small></a></p>
            ...
            <i id="11"/>
            <p>11. РАЗРЕШЕНИЕ СПОРОВ, ОБЯЗАТЕЛЬНЫЙ АРБИТРАЖ И ОТКАЗ ОТ КОЛЛЕКТИВНОГО ИСКА<a href="#0"><small> ⏶</small></a>
            </p>
            ...
            <i id="12"/>
            <p>12. РАЗНОЕ<a href="#0"><small> ⏶</small></a></p>
